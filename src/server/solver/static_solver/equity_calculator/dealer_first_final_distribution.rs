...
use super::dealer_value_final_distribution::EDealerFinalValue;
use super::dealer_value_final_distribution;
...
mod test {
    ...
    use super::super::dealer_first_final_distribution::get_table;
