...
use crate::solver::static_solver::equity_caculator::{player_value_stand_equity, value_hit_distribution};
...
mod test {
    ...
    use crate::deck::TDeck;
    use crate::solver::static_solver::equity_caculator::player_value_hit_equity::get_table;
