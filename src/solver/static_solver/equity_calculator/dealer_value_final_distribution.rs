...
use crate::solver::static_solver::equity_caculator::value_hit_distribution;
...
mod test {
    ...
    use crate::deck::TDeck;
    use crate::solver::static_solver::equity_caculator::dealer_value_final_distribution::get_table;
    #[test]
    fn test_table() {
